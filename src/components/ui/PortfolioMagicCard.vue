<template>
  ...
  >
    ...
    <!-- Project Image -->
    <div class="relative z-10 mb-3 bg-gray-200 dark:bg-gray-700 rounded overflow-hidden">
      <div v-if="!imageLoaded" class="w-full h-32 flex items-center justify-center">
      ...
      <img
        ...
        :class="['w-full h-32 object-cover border border-gray-100 dark:border-gray-700 transition-opacity duration-300', imageLoaded ? 'opacity-100' : 'opacity-0']"
      />
    </div>
